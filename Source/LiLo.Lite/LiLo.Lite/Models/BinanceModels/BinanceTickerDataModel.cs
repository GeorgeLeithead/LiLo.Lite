...
namespace LiLo.Lite.Models.BinanceModels
{
	...
	{
		private CultureInfo uensCultureFormat = new CultureInfo("en-US");
		...
		public double HighPrice24h => Convert.ToDouble(this.HighPrice, this.uensCultureFormat);

		/// <summary>Gets the last price.</summary>
		public double LastPrice => Convert.ToDouble(this.CurrentPrice, this.uensCultureFormat);
		...
		public double LowPrice24h => Convert.ToDouble(this.LowPrice, this.uensCultureFormat);
		...
		public double PriceChange => Convert.ToDouble(this.PChange, this.uensCultureFormat);

		/// <summary>Gets the 24hr price change percent.</summary>
		public double Price24hPercent => Convert.ToDouble(this.Percent, this.uensCultureFormat);
